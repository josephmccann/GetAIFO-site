    ...
    <section className="relative min-h-[90vh] flex items-center pt-24 pb-12 overflow-hidden">
      ...
      <div className="container-custom relative z-10 grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
        <motion.div
          ...
          className="max-w-2xl"
        >
          <p className="text-xs font-bold tracking-[0.2em] uppercase mb-6" style={{ color: "#E8820C" }}>
            AI.FO &bull; Early Access
          </p>
          <div className="mb-6">
            <h1 className="font-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl tracking-tight text-[#1E2761] mb-2" data-testid="hero-heading">
              Financial judgment that works while you sleep.
            </h1>
            <div className="w-24 h-1 bg-accent rounded-full mt-6"></div>
          </div>
          <p className="font-body text-base md:text-lg leading-relaxed text-[#1E2761] mb-2 max-w-xl" data-testid="hero-subhead">
          ...
          <p className="font-body text-base md:text-lg leading-relaxed text-[#4A5578] mb-10 max-w-xl">
        ...
        {/* Abstract Visual Panel  kept dark to evoke the product's internal UI */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <div className="absolute inset-0 overflow-hidden flex items-center justify-center rounded-lg border border-[rgba(30,39,97,0.15)] shadow-[0_8px_32px_rgba(30,39,97,0.12)]" style={{ background: "linear-gradient(145deg, #1A2740 0%, #223352 40%, #283D5E 100%)" }}>
            ...
            >
              <span className="text-[#F87171] font-semibold text-xs lg:text-sm">Burn &uarr; 22%</span>
            </motion.div>
