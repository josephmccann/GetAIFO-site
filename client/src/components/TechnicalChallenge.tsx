...
export default function TechnicalChallenge() {
  return (
    <section id="technical" className="section-padding border-t border-[rgba(30,39,97,0.12)]">
      <div className="container-custom">
        <span className="text-label">THE ARCHITECTURE</span>
        <div className="mb-12">
          <h2 className="text-5xl md:text-6xl text-foreground">Deterministic Reasoning. Generative Communication.</h2>
        </div>
