export default function WhoWhy() {
  return (
    <section id="why-built" className="section-padding border-t border-[#A8B8D8]">
      <div className="max-w-3xl mx-auto px-6 md:px-8">
        <span className="text-label">WHY WE BUILT THIS</span>
        <h2 className="font-display text-3xl md:text-4xl lg:text-5xl text-[#1E2761] mb-10">
        ...
        <p className="text-[#4A5578] text-sm mt-8">
