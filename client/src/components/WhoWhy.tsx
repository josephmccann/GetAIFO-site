export default function WhoWhy() {
  return (
    <section id="why-built" className="section-padding border-t border-[rgba(30,39,97,0.12)]">
      <div className="max-w-3xl mx-auto px-6 md:px-8">
        <span className="text-label">WHY WE BUILT THIS</span>
        <h2 className="font-display text-3xl md:text-4xl lg:text-5xl text-foreground mb-10">
