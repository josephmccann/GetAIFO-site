...
export default function Problem() {
  ...
  return (
    <section id="problem" className="section-padding border-t border-[#A8B8D8]">
      <div className="container-custom">
        <span className="text-label">THE PROBLEM</span>
        <div className="max-w-3xl mb-16">
          <h2 className="text-5xl md:text-6xl text-[#1E2761] mb-6 leading-tight">
            CFO-level decisions begin far earlier than CFO-level staffing.
          </h2>
          <p className="text-xl md:text-2xl text-[#4A5578]">
        ...
        <div className="text-center max-w-4xl mx-auto">
          <h3 className="text-3xl md:text-4xl text-[#1E2761]">
