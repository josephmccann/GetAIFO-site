    ...
    <div className="min-h-screen bg-[#C8D4F0] text-[#1E2761] font-body font-light">
      ...
      <main className="pt-32 pb-20">
        <div className="container-custom max-w-3xl">
          ...
          <h1 className="font-display text-5xl md:text-6xl text-[#1E2761] mb-8" data-testid="heading-privacy">
            Privacy Policy
          </h1>
          <div className="space-y-6 text-[#1E2761] leading-relaxed">
            ...
            <h2 className="font-display text-2xl text-[#1E2761] pt-4">Information We Collect</h2>
            <p>
            ...
            <h2 className="font-display text-2xl text-[#1E2761] pt-4">How We Use Your Information</h2>
            <p>
            ...
            <h2 className="font-display text-2xl text-[#1E2761] pt-4">Data Storage</h2>
            <p>
